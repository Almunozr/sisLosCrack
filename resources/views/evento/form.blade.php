<div class="box box-info padding-1">
    <div class="box-body">
        ...
        {{-- <div class="form-group">
            {{ Form::label('Asignado') }}
            {{ Form::select('Asignado', $evento->valor, ['class' => 'form-control' . ($errors->has('valor') ? ' is-invalid' : ''), 'placeholder' => 'Valor']) }}
            {!! $errors->first('valor', '<div class="invalid-feedback">:message</div>') !!}
        </div> --}}
        <div class="form-group">
            {{ Form::label('valor') }}
            {{ Form::text('valor', $evento->valor, ['class' => 'form-control' . ($errors->has('valor') ? ' is-invalid' : ''), 'placeholder' => 'Valor']) }}
            {!! $errors->first('valor', '<div class="invalid-feedback">:message</div>') !!}
        </div>
